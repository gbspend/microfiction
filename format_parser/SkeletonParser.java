...
public class SkeletonParser {
	...
	static String[] files = new String[] {"selectedexemplars", "filteredexemplars", "6ws-reddit-top2.txt", "6ws-twitter-ernest6words.txt", "6ws-twitter-sixwordstories.txt", "6ws-reddit-top1.txt"};
